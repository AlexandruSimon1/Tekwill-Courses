...
public class Demo {
    public static void main(String[] args) {
        ...
        filter(employees, new ValidateName());

        Validate validateAddress = new Validate() {
            @Override
        ...
        Validate validateNameV2 = (Employee emp) -> emp.name.length() > 5;

        filter(employees, validateNameV2);

        Validate validateNameV3 =  emp -> emp.name.length() > 5;
    ...
    static void filter(List<Employee> employees, Validate v){
